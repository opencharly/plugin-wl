...
#WlInput: {
	...
	method: "status" | "toplevel" | "windows" | "geometry" | "xprop" | "atspi" | "screenshot" | "ocr" | "clipboard" | "click" | "double-click" | "mouse" | "scroll" | "drag" | "type" | "key" | "key-combo" | "focus" | "close" | "fullscreen" | "minimize" | "exec" | "resolution" | "overlay-list" | "overlay-status" | "overlay-show" | "overlay-hide" | "hypr-monitors" | "hypr-clients" | "hypr-layers" | "hypr-workspaces" | "hypr-systeminfo" | "hypr-dispatch" | "hypr-eval" | "sway-tree" | "sway-workspaces" | "sway-outputs" | "sway-msg" | "sway-focus" | "sway-move" | "sway-resize" | "sway-layout" | "sway-workspace" | "sway-kill" | "sway-floating" | "sway-reload"
